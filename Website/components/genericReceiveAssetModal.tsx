...
import { Modal, ModalBody, ModalContent, ModalOverlay, VStack, Text, Spinner, Button } from "@chakra-ui/react";
            ...
            <ModalContent className="bg-transparent">
                <ModalBody className="overflow-hidden p-0">
                    <div className="relative flex flex-col gap-4 overflow-hidden rounded-2xl bg-slate-900/80 p-8 backdrop-blur-md">
                        ...
                        {description && <p className="text-center text-lg text-white/90">{description}</p>}
                        ...
                        {(success || failed) && (
                            <div className="flex justify-center">
                                <Button h={12} onClick={closeWarning}>
                                    Close
                                </Button>
                            </div>
                        )}
